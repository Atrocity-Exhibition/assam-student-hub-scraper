...
def test_apsc_scraper():
    print("=== Launching APSC Scraper Test ===")
    
    # Initialize the scraper for the target year 2026
    scraper = APSCScraper(year=2026)
    ...
    assert len(items) > 0, "Error: Scraper returned 0 items from APSC!"
    ...
    assert first_item.institution_slug == "assam-public-service-commission", "Institution slug is invalid"
    ...
    print("\n[SUCCESS] All basic structure checks passed successfully!")
